...
import { ArrowRight, Leaf, Heart, Shield, Sparkles, Users, Award, User } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Our Story',
  description: 'Learn about Kumfora\'s mission to provide comfortable, confident period care for girls. Made with love, backed by science.',
};

const values = [
  { icon: Heart, title: 'Girl-First Design', desc: 'Every product is designed with real girls\' feedback and needs at the center.' },
  { icon: Shield, title: 'Safety First', desc: 'Dermatologically tested, free from harsh chemicals, fragrances, and chlorine.' },
  { icon: Leaf, title: 'Planet Conscious', desc: 'Biodegradable wrappers, sustainable sourcing, and minimal packaging waste.' },
  { icon: Sparkles, title: 'Honest Quality', desc: 'No false claims. Premium materials that deliver on every promise.' },
];

const milestones = [
  { year: '2022', title: 'The Spark', desc: 'Founder notices her daughter struggling with uncomfortable, adult-sized pads.' },
  { year: '2023', title: 'Research & Development', desc: '18 months of testing with pediatric dermatologists and 200+ girls across India.' },
  { year: '2023', title: 'First Prototype', desc: 'Ultra-thin, leak-guard design with biodegradable wrapper - tested and approved.' },
  { year: '2024', title: 'Kumfora Launches', desc: 'Day and Night pads available nationwide. 500+ families join in the first month.' },
  { year: '2024', title: 'Growing Community', desc: 'Period Guide launched. Schools partnership program begins. 5000+ happy customers.' },
];

const team = [
  { name: 'Meera Patel', role: 'Founder & CEO', desc: 'Mom of two, former P&G brand manager' },
  { name: 'Dr. Anjali Rao', role: 'Medical Advisor', desc: 'Pediatric dermatologist, AIIMS Delhi' },
  { name: 'Rohit Sharma', role: 'Product Lead', desc: 'Ex-Unilever, 10+ years in hygiene' },
  { name: 'Sneha Gupta', role: 'Community Manager', desc: 'Period educator & youth mentor' },
];
        ...
        <div className="container-main relative z-10 py-16 lg:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-display-xl font-display font-medium text-kumfora-charcoal mb-6 text-balance">
              Made with <span className="text-kumfora-terracotta">Love</span>, Backed by Science
            </h1>
            <p className="text-body-lg text-kumfora-slate mb-8 max-w-2xl mx-auto">
              Kumfora was born from a simple observation: most period products are designed for adult women,
              not growing girls. We&apos;re changing that — one comfortable period at a time.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link href="/shop" className="btn-primary">Shop Our Pads</Link>
              <Link href="/guide" className="btn-secondary">Read Period Guide</Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-body-lg text-kumfora-slate mb-6">
                Every girl deserves period care that fits her body, her lifestyle, and her confidence.
                Not hand-me-downs from adult products. Not one-size-fits-all compromises.
              </p>
              <p className="text-body text-kumfora-gray mb-6">
                We&apos;re building the period brand we wished existed when we were young — one that celebrates
                this milestone instead of hiding it. Products that make girls feel capable, not self-conscious.
              </p>
              <p className="text-body text-kumfora-gray">
                From the absorbency core to the biodegradable wrapper, every decision is made with her comfort
                and future in mind.
              </p>
            </div>
            <div className="relative aspect-[4/3]">
              ...
              <div className="relative z-10 h-full rounded-3xl overflow-hidden bg-white flex items-center justify-center">
                <div className="text-center p-8 max-w-md">
                  ...
                  <h3 className="text-display-md font-display font-medium text-kumfora-charcoal mb-3">Designed for Her</h3>
                  <p className="text-body text-kumfora-slate">Every curve, every layer, every detail — thoughtfully crafted for young girls&apos; comfort.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-kumfora-cream/30" aria-labelledby="values-heading">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-16">
            ...
            <p className="text-body-lg text-kumfora-slate">The principles that guide every product, every decision, every interaction.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value) => (
              <article key={value.title} className="card p-6 text-center hover:shadow-card-hover transition-shadow">
                <div className="w-14 h-14 rounded-xl bg-kumfora-blush flex items-center justify-center mx-auto mb-4">
                  <value.icon className="w-7 h-7 text-kumfora-terracotta" aria-hidden="true" />
                </div>
                <h3 className="text-heading-md font-display font-medium text-kumfora-charcoal mb-2">{value.title}</h3>
      ...
      <section className="py-16 lg:py-24 bg-white" aria-labelledby="journey-heading">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-16">
            ...
            <p className="text-body-lg text-kumfora-slate">From a mother&apos;s observation to thousands of confident girls.</p>
          </div>
              ...
              {milestones.map((milestone) => (
                <li key={milestone.year} className="relative flex gap-4 sm:gap-6">
                  ...
                  <div className="flex-1 pt-2">
                    ...
                    <p className="text-body text-kumfora-slate mt-1">{milestone.desc}</p>
                  </div>
                </li>
              ))}
            </ol>
      ...
      <section className="py-16 lg:py-24 bg-kumfora-cream/30" aria-labelledby="team-heading">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-16">
            ...
            <p className="text-body-lg text-kumfora-slate">Real people who care deeply about making periods comfortable.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member) => (
              <article key={member.name} className="card p-6 text-center">
                ...
                <h3 className="text-heading-md font-display font-medium text-kumfora-charcoal">{member.name}</h3>
                <p className="text-body-sm text-kumfora-terracotta font-medium">{member.role}</p>
                <p className="text-body-sm text-kumfora-gray mt-1">{member.desc}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-kumfora-charcoal" aria-labelledby="trust-heading">
        <div className="container-main">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-16">
            ...
            <p className="text-body-lg text-kumfora-rose/70">Join 5000+ parents who&apos;ve made the switch to comfort.</p>
          </div>
            ...
            {[
              ...
              <div key={item.label} className="text-center p-6">
                <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center mx-auto mb-4">
                  <item.icon className="w-7 h-7 text-kumfora-coral" aria-hidden="true" />
                </div>
                <p className="text-display-md font-display font-bold text-kumfora-white">{item.stat}</p>
                <p className="text-body text-kumfora-rose/70 mt-1">{item.label}</p>
              </div>
            ))}
          </div>
        </div>
