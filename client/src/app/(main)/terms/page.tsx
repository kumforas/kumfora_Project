        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-body text-kumfora-slate leading-relaxed">
              By accessing and using the Kumfora website and services, you agree
          ...
          <section>
            ...
            <p className="text-body text-kumfora-slate leading-relaxed">
              We accept cash on delivery and credit/debit card payments. All
          ...
          <section>
            ...
            <p className="text-body text-kumfora-slate leading-relaxed">
              We offer free shipping on orders over ₹499. Standard delivery
              takes 3-7 business days. Delivery times may vary based on
              location. See our{" "}
              <Link
                href="/shipping"
                className="text-kumfora-hotPink hover:underline"
              >
                Shipping Policy
              </Link>{" "}
              for details.
          ...
          <section>
            ...
            <p className="text-body text-kumfora-slate leading-relaxed">
              ...
              and in original packaging. See our{" "}
              <Link
                href="/returns"
                className="text-kumfora-hotPink hover:underline"
              >
          ...
          <section>
            ...
            <p className="text-body text-kumfora-slate leading-relaxed">
              Kumfora shall not be liable for any indirect, incidental, or
