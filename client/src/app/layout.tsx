...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.kumfora.com"),
  title: {
  ...
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://www.kumfora.com",
    siteName: "Kumfora",
    title: "Kumfora - Comfortable Period Care for Girls",
    description:
      "Discover Kumfora's premium period pads designed for girls. Ultra-soft, leak-proof, and eco-friendly.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
